...
const content: Array<ChallengeEntryInput> = [
  ...
  { status: "done", title: "CI/CD-Backend", description: "The backend should be automatically deployed/updated, whenether a new commit comes in, and the Tests are passing.", comment: "Another reason to use JS, and explore the testing framework XYZ" },
