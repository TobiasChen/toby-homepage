...
export default function About(prop: { title: string }) {
  ...
  return (
    <div className="main flex flex-col justify-center grow max-w-5xl mt-10 mb-10 gap-3 ">
      <span className="flex items-center flex-row gap-5"></span>
      ...
      <p>
        <a href="#1_information">I. Information about us as controllers of your data</a>
        <br />
        <a href="#2_theRights">II. The rights of users and data subjects</a>
        <br />
        <a href="#3_information">III. Information about the data processing</a>
      </p>
      <h3 className=" text-3xl" id="#1_information">I. Information about us as controllers of your data</h3>
      <p>
      ...
      <h3 id="3_information" className=" text-3xl">III. Information about the data processing</h3>{" "}
      <p>
      ...
      <h4 className=" text-2xl">Server data</h4>
      <p>
      ...
      <h4 className="text-2xl jet-listing-dynamic-field__content">General introduction</h4>
      <h4 className="text-2xl jet-listing-dynamic-field__content">LinkedIn</h4>
      <p>
        LinkedIn Ireland Unlimited Company, Wilton Plaza, Wilton Place, Dublin
        2, Irland, a subsidiary of LinkedIn Corporation, 1000 W. Maude Avenue,
