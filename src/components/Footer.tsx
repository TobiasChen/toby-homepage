...
import black from "../assets/github-mark.svg"
import { ReactComponent as TestSVG } from "../assets/github-mark.svg";
    ...
    <div className="flex items-baseline h-16">
        <div className="flex flex-row items-center gap-2">
            <a href="https://github.com/TobiasChen/toby-homepage" target="_blank" className="flex items-center gap-1" >
                <TestSVG className="fill-default-color" width="24" height="24" viewBox="0 0 100 100"></TestSVG>
